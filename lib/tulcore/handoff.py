...
def compact_handoff(*, repo: Path, project: str, mode: str, expected_repo: str | None, **kwargs) -> str:
    ...
    lines.extend([
        ...
        "2. Read `docs/llm/entrypoint.md` before proposing the next package.",
        "3. Preserve push-by-default, no broad staging, no force push, and config/policy separation.",
        "4. For next work, propose or produce one cross-platform `tul-package.yml + files/ + README.md` package.",
        "",
