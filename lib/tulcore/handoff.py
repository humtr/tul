...
def compact_handoff(*, repo: Path, project: str, mode: str, expected_repo: str | None, **kwargs) -> str:
    ...
    lines.extend([
        ...
        "2. Read `docs/llm/entrypoint.md` and `docs/llm/post-update-review.md` before proposing the next package.",
        ...
        "5. For next work, propose or produce one cross-platform `tul-package.yml + files/ + README.md` package.",
        "",
...
def full_handoff(*, repo: Path, project: str, mode: str, expected_repo: str | None, validation: list[str] | None = None, **kwargs) -> str:
    ...
    lines.extend([
        ...
        "4. Read `docs/llm/entrypoint.md`, `docs/llm/post-update-review.md`, `docs/status/current.md`, and `docs/roadmap.md` before proposing implementation.",
